...
export function Card({
  ...
  const variantClasses = {
    ...
    glass:
      'bg-white/80 dark:bg-navy/80 backdrop-blur-xl border border-white/20 dark:border-white/10 shadow-lg',
...
export function CardTitle({
  ...
  return (
    <h3
      className={cn('font-display font-bold text-heading-md text-foreground', className)}
      {...props}
    >
      {children}
    </h3>
...
export function CardDescription({
  ...
  return (
    <p className={cn('text-body-sm text-muted-foreground mt-1', className)} {...props}>
      {children}
    </p>
  );
}
