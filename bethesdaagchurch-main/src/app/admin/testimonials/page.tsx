    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {tests.map((t) => (
          <div
            key={t.id}
            className="bg-navy border border-gold/20 p-6 rounded-2xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 shadow-xl"
          >
            <div className="space-y-1">
              ...
              <p className="text-xs text-ivory/80 italic line-clamp-2">
            ...
            <div className="flex items-center gap-2 shrink-0">
              <Button
                variant="gold"
                size="sm"
                onClick={() => addToast({ type: 'success', title: 'Testimony Approved' })}
              >
                Approve ✓
              </Button>
              <button
                onClick={() => {
                  ...
                  addToast({ type: 'info', title: 'Testimony Rejected' });
                }}
                className="px-3 py-1.5 bg-red-600/30 text-red-400 rounded-lg text-xs font-semibold"
              >
                Reject
              </button>
            </div>
