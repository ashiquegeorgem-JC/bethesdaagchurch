...
export default function AdminMembersPage() {
  const members = [
    { id: '1', name: 'Sarah Johnson', email: 'sarah@example.com', phone: '+91 98765 43210', group: 'Faith Builders', joined: '2022-03-15' },
    { id: '2', name: 'Priya Sharma', email: 'priya@example.com', phone: '+91 98123 45678', group: 'Women of the Word', joined: '2021-08-20' },
    { id: '3', name: 'Rahul Menon', email: 'rahul@example.com', phone: '+91 98987 65432', group: 'Young Professionals', joined: '2023-01-10' },
  ];
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xs text-ivory/60">View registered church members and group affiliations</p>
      </div>
