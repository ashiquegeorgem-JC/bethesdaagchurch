...
export default function AdminSettingsPage() {
  ...
  return (
    <div className="max-w-3xl space-y-6">
      ...
      <form
        onSubmit={handleSave}
        className="bg-navy border border-gold/20 p-8 rounded-3xl space-y-6 shadow-xl text-xs text-ivory"
      >
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              defaultValue="Bethesda AG Church"
              className="w-full px-4 py-2.5 bg-navy-deep border border-gold/30 rounded-xl text-ivory focus:outline-none focus:ring-1 focus:ring-gold"
            />
          </div>
          ...
          <div>
            ...
            <input
              defaultValue="A place to belong. A place to grow. A place to encounter God."
              className="w-full px-4 py-2.5 bg-navy-deep border border-gold/30 rounded-xl text-ivory focus:outline-none focus:ring-1 focus:ring-gold"
            />
          </div>
          ...
          <div>
            ...
            <input
              defaultValue="contact@bethesdaag.org"
              className="w-full px-4 py-2.5 bg-navy-deep border border-gold/30 rounded-xl text-ivory focus:outline-none focus:ring-1 focus:ring-gold"
            />
          </div>
