      ...
      <main className="min-h-screen bg-background pb-20">
        ...
        <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="bg-card border border-border p-8 rounded-3xl shadow-sm mt-6 space-y-6">
            <div className="space-y-2">
              ...
              <p className="text-body text-muted-foreground font-medium flex items-center gap-1.5">
                <svg
            ...
            {event.schedule && event.schedule.length > 0 && (
              <div>
                <h3 className="font-display font-bold text-heading-md text-foreground mb-4">
                  Event Schedule
                </h3>
                <div className="space-y-4">
                  {event.schedule.map((dayItem, i) => (
                    <div
                      key={i}
                      className="p-4 bg-input border border-border rounded-2xl space-y-2"
                    >
        ...
        <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="bg-navy text-ivory border border-gold/30 p-8 rounded-3xl shadow-2xl">
            <h2 className="font-display font-bold text-heading-xl text-gold mb-2">
              Register for Event
            </h2>
            <p className="text-body-sm text-ivory/80 mb-6">
              Reserve your spot now. Registration is free and open to everyone.
            </p>

            {submitted ? (
              <div className="p-6 bg-emerald-500/20 border border-emerald-500/40 rounded-2xl text-center space-y-3">
                <span className="text-4xl">✓</span>
                <h3 className="font-display font-bold text-heading-md text-emerald-400">
              ...
              <form onSubmit={handleRegister} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-navy-deep border border-gold/30 rounded-xl text-ivory focus:outline-none focus:ring-2 focus:ring-gold text-sm"
                  />
                </div>
                <div>
                  <label className="block text-xs font-semibold text-ivory mb-1">
                    Email Address
                  </label>
                  <input
                    required
