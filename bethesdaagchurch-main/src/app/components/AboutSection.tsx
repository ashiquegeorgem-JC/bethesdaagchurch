      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
            ...
            <div className="glass-card-ivory rounded-3xl p-8 border border-church-gold/25 shadow-md relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <h3 className="font-display text-2xl font-bold text-church-green mb-3">
                  Our Mission
                </h3>
                <p className="text-church-bronze/70 text-xs italic mb-3">
                ...
                <div className="flex flex-wrap gap-2">
                  {['Loving Genuinely', 'Serving Selflessly', 'Reflecting Christ']?.map((tag) => (
                    <span
                      key={tag}
                      className="px-3 py-1 rounded-full bg-church-green/10 text-church-green text-xs font-semibold border border-church-green/20"
                    >
                      {tag}
                    </span>
                  ))}
            ...
            <div className="glass-card-ivory rounded-3xl p-8 border border-church-gold/25 shadow-md relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-church-bronze text-sm leading-relaxed mb-5">
                  To be a transformative community that raises up passionate disciples of Jesus. We
                  aim to instill Kingdom values in every believer, empowering them to impact their
                  homes, workplaces, and the city of Bangalore for Christ.
                </p>
                <div className="flex flex-wrap gap-2">
                  {['Raising Disciples', 'Instilling Kingdom Values', 'Impacting Our World']?.map(
                    (tag) => (
                      <span
                        key={tag}
                        className="px-3 py-1 rounded-full bg-church-gold/10 text-church-bronze text-xs font-semibold border border-church-gold/30"
                      >
                        {tag}
                      </span>
                    )
        ...
        <div className="animate-on-scroll rounded-3xl p-8 sm:p-10 bg-white border border-church-gold/30 shadow-lg relative overflow-hidden">
          <div
            ...
            style={{
              background:
                'linear-gradient(135deg, rgba(255,255,255,1) 0%, rgba(245,240,225,0.6) 100%)',
            }}
          />
          <div className="relative z-10 text-center max-w-3xl mx-auto">
            ...
            <p className="font-display text-church-green text-sm uppercase tracking-widest font-bold mb-3">
              Our Promise to You
            </p>
            ...
            <p className="font-display text-xl sm:text-2xl font-medium text-church-green leading-relaxed italic">
              &ldquo;Every person who walks through our doors will encounter God&apos;s Presence,
              Genuine Love, Biblical Teaching, Authentic Community, and Practical Hope.&rdquo;
            </p>
            <div className="mt-6">
              <Link
                href="/about"
