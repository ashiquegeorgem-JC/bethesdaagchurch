    ...
    svg: (
      ...
      >
        <path
          ...
          d="M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 .895-2 3-2c.58 0 1.124.11 1.6.305M21 16c0 1.105-1.343 2-3 2s-3-.895-3-2 .895-2 3-2c.58 0 1.124.11 1.6.305M21 3v3L9 9"
        />
      </svg>
    ),
  },
          ...
          {PILLARS.map((item, idx) => (
            ...
            >
              <div className="space-y-4">
                ...
                <span className="text-overline font-semibold text-gold uppercase tracking-wider block">
                  {item.title}
                </span>
                <h3 className="font-display font-bold text-heading-md text-charcoal dark:text-ivory leading-snug">
                  {item.description}
                </h3>
                <p className="text-body-sm text-muted-text dark:text-ivory/80 leading-relaxed">
                  {item.detail}
                </p>
              </div>
            </motion.div>
