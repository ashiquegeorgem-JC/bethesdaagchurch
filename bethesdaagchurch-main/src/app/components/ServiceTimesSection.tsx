...
const sundayServices = [
  {
    ...
    note: 'Main Hall',
    color: 'from-church-green/90 to-church-green/70',
  },
  {
    languages: 'Malayalam / Kannada',
    time: '9:30 AM – 11:30 AM',
    note: 'Main Hall',
    color: 'from-church-green/80 to-church-green/60',
  },
  {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-14 animate-on-scroll">
          ...
          <p className="text-church-bronze mt-4 max-w-xl mx-auto text-sm sm:text-base">
            We celebrate God&apos;s presence in multiple languages every Sunday — because every
            heart deserves to worship in its mother tongue.
          </p>
        </div>
            ...
            {sundayServices?.map((service, i) => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <h3 className="font-display text-base font-semibold text-church-green mb-1 leading-snug">
                    {service?.languages}
                  </h3>
              ...
              >
                <div className="flex items-start gap-3">
                  <div className="w-9 h-9 rounded-full bg-church-green/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <svg
                      className="w-4 h-4 text-church-green"
                      fill="none"
                      stroke="currentColor"
                      strokeWidth="1.5"
                      viewBox="0 0 24 24"
                  ...
                  <div>
                    <p className="text-xs font-bold text-church-bronze/60 uppercase tracking-wide mb-0.5">
                      {service?.days}
                    </p>
                    <h4 className="font-display text-sm font-semibold text-church-green mb-1">
                      {service?.name}
                    </h4>
        ...
        <div className="animate-on-scroll" style={{ transitionDelay: '300ms' }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            {weeklyServices?.map((service, i) => (
              ...
              >
                <p className="text-church-green font-bold text-xs uppercase tracking-wide mb-1">
                  {service?.day}
                </p>
                <h4 className="font-display text-sm font-semibold text-church-green mb-1 leading-snug">
                  {service?.name}
                </h4>
                <p className="text-church-gold text-xs font-semibold">{service?.time}</p>
              </div>
