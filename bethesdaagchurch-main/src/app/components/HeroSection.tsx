    ...
    <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden bg-ivory text-charcoal py-20">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <span className="text-overline font-semibold tracking-[0.25em] uppercase text-gold">BETHESDA AG CHURCH</span>
          <span className="w-8 h-px bg-gold" />
        </motion.div>
        ...
        >
          A community of faith in Bengaluru, growing together through worship, the Word, prayer, and fellowship.
        </motion.p>
        ...
        >
          <span className="text-[10px] uppercase tracking-widest text-muted-text font-medium">Scroll to explore</span>
