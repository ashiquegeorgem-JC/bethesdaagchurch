...
export default function DevotionsSection() {
  ...
  return (
    <section ref={sectionRef} className="py-20 bg-church-green relative overflow-hidden" aria-labelledby="devotions-heading">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="animate-on-scroll glass-card rounded-3xl p-8 border border-church-gold/20">
            ...
            <h2 id="devotions-heading" className="font-display text-2xl sm:text-3xl font-bold text-white mb-3">
              Daily Devotions
            </h2>
            <p className="text-white/70 text-sm leading-relaxed mb-6">
              Start every morning in God's Word. Our daily devotional readings are crafted to encourage, challenge, and anchor you in scripture — available in multiple languages.
            </p>
            <div className="glass-card rounded-xl p-5 border border-church-gold/15 mb-6">
              <p className="text-church-gold text-xs font-semibold uppercase tracking-wide mb-2">Today's Verse</p>
          ...
          {/* Online Bible Study */}
          <div className="animate-on-scroll glass-card rounded-3xl p-8 border border-church-gold/20" style={{ transitionDelay: '200ms' }}>
            <div className="w-12 h-12 rounded-full bg-church-gold/20 flex items-center justify-center mb-6">
              <svg className="w-6 h-6 text-church-gold" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <p className="text-white/70 text-sm leading-relaxed mb-6">
              Join our weekly online Bible study sessions — interactive, in-depth, and available for all levels of biblical knowledge. Study with a community that loves God's Word.
            </p>
            <div className="space-y-3 mb-6">
              {[
                ...
                <div key={item?.label} className="flex gap-3 text-sm">
                  <span className="text-church-gold font-semibold w-24 flex-shrink-0">{item?.label}:</span>
