...
export default function FeaturedSermon() {
  ...
  const [featured, setFeatured] = useState<YouTubeVideo | null>(null);
  ...
  const videoUrl = featured?.url || 'https://www.youtube.com/@Bethesda_AG';
  const thumbnail =
    featured?.thumbnail || 'https://images.unsplash.com/photo-1715610067656-629b6b8fd5a8';
  const title = featured?.title || 'Worship & Word Service — Bethesda AG Church';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5">
            <div className="lg:col-span-3 relative aspect-video overflow-hidden group">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                ...
                >
                  <svg
                    className="w-9 h-9 text-church-green ml-1"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                    aria-hidden="true"
                  >
            ...
            <div className="lg:col-span-2 p-8 flex flex-col justify-center">
              <p className="text-church-gold text-xs font-semibold uppercase tracking-widest mb-2">
                Bethesda AG Church
              </p>
              <h3 className="font-display text-2xl sm:text-3xl font-bold text-church-green mb-3 leading-snug">
                {title}
              </h3>
              <p className="text-church-bronze text-sm mb-4">Official YouTube Stream · Bengaluru</p>
              <p className="text-church-bronze/80 text-sm leading-relaxed mb-6">
                Watch and be blessed by the latest sermon delivered at Bethesda AG Church. Streamed
                directly from our sanctuary.
              </p>
