          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-5 space-y-8">
              <div className="bg-card border border-border p-8 rounded-3xl shadow-sm space-y-6">
                <h3 className="font-display font-bold text-heading-lg text-foreground">
                  Church Information
                </h3>
                ...
                <div className="space-y-4 text-body-sm text-foreground">
                  ...
                  <div className="flex items-start gap-3">
                    <svg
                      className="w-5 h-5 text-[#25D366] shrink-0 mt-0.5 fill-current"
                      viewBox="0 0 24 24"
                    >
                    ...
                    <div>
                      ...
                      <a
                        href={`https://wa.me/${CHURCH_INFO.whatsapp}?text=${encodeURIComponent('Hello Bethesda AG Church! I would like to get in touch.')}`}
                        target="_blank"
