    ...
    >
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 relative z-10">
        <div className="text-center mb-10">
          ...
          <p className="text-church-bronze text-sm max-w-lg mx-auto">
            We&apos;re more than a church; we&apos;re a family. Whether you have a question, need
            prayer, or want to know more about our community, we&apos;re here for you.
          </p>
        </div>
        ...
        {submitted ? (
          <div className="glass-card-ivory rounded-3xl p-10 border border-church-gold/25 text-center">
            ...
            <h3 className="font-display text-2xl font-bold text-church-green mb-2">
              Message Sent!
            </h3>
            <p className="text-church-bronze text-sm">
              Thank you for reaching out. We&apos;ll be in touch with you very soon. God bless you!
            </p>
          </div>
        ) : (
          <form
            onSubmit={handleSubmit}
            className="glass-card-ivory rounded-3xl p-8 border border-church-gold/25 shadow-xl space-y-5"
          >
            <div>
              <label
                htmlFor="name"
                className="block text-church-bronze text-xs font-semibold uppercase tracking-wide mb-1.5"
              >
                Full Name *
              </label>
              <input
