...
export default function ContactDetails() {
  ...
  return (
    <section ref={sectionRef} className="py-20 bg-church-ivory relative overflow-hidden" aria-labelledby="contact-details-heading">
      <div className="absolute inset-0 wave-texture opacity-30 pointer-events-none" />
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          {/* Map */}
          <div className="animate-on-scroll rounded-3xl overflow-hidden shadow-xl border border-church-gold/20" style={{ height: '450px' }}>
            <iframe
          ...
          <div className="animate-on-scroll space-y-5" style={{ transitionDelay: '200ms' }}>
            <h2 id="contact-details-heading" className="font-display text-3xl sm:text-4xl font-bold text-church-green mb-6">
            ...
            {[
              {
                ...
                title: 'Address',
                content: 'No. 36-B, Near Cafe Coffee Day, 42nd Cross, 8th Main Cross Road, 4th Block, Rajajinagar, Bengaluru, Karnataka 560010',
                href: undefined,
              },
              {
              ...
              <div key={item?.title} className="glass-card-ivory rounded-2xl p-5 border border-church-gold/20 flex gap-4 items-start">
                ...
                <div>
                  ...
                  {item?.href ? (
                    <a href={item?.href} className="text-church-bronze text-sm hover:text-church-green transition-colors">{item?.content}</a>
                  ) : (
