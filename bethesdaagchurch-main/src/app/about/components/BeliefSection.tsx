...
const beliefs = [
  {
    title: 'The Bible',
    desc: 'We believe the Bible is the inspired, infallible Word of God — the supreme authority for faith and life.',
  },
  {
    title: 'The Trinity',
  ...
  {
    title: 'Salvation',
    desc: 'We believe salvation is received through repentance and faith in Jesus Christ alone — by grace, not works.',
  },
  {
    title: 'The Holy Spirit',
    desc: 'We believe in the baptism of the Holy Spirit, with the evidence of speaking in tongues, as a gift for every believer.',
  },
  {
    title: 'Divine Healing',
    desc: "We believe in divine healing as provided in Christ's atonement and available to all who believe.",
  },
  {
    title: 'The Second Coming',
    desc: 'We believe in the personal, imminent return of Jesus Christ for His church.',
  },
];
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-14 animate-on-scroll">
          <span className="text-xs font-semibold tracking-widest uppercase text-church-gold/70 mb-3 block">
            What We Believe
          </span>
