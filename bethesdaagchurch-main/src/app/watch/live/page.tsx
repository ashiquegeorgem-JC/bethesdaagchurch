      ...
      <main className="min-h-screen bg-navy text-ivory pb-20">
        ...
        <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <span className="text-overline font-semibold uppercase text-gold tracking-widest">OFFICIAL YOUTUBE LIVE STREAM</span>
              <h1 className="font-display font-bold text-2xl sm:text-3xl text-ivory">Bethesda AG Church Live</h1>
            </div>
            <a
              href="https://www.youtube.com/@Bethesda_AG/live"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-[#FF0000] text-white px-4 py-2 rounded-xl text-xs font-bold uppercase tracking-wider hover:bg-red-700 transition-colors shadow-lg"
            >
          ...
          <div className="relative aspect-video rounded-3xl overflow-hidden bg-navy-deep border border-gold/40 shadow-2xl">
            <iframe
              src="https://www.youtube.com/embed/live_stream?channel=@Bethesda_AG"
          ...
          <div className="mt-8 bg-navy-deep border border-gold/20 p-6 rounded-2xl space-y-4">
            <h3 className="font-display font-bold text-heading-md text-gold">Live Stream Chat & Prayer</h3>
