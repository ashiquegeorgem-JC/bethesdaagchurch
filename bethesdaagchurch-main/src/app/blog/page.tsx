      ...
      <main className="min-h-screen bg-background pb-20">
        ...
        <section className="section bg-navy text-ivory text-center py-16">
          <div className="max-w-4xl mx-auto px-4">
            ...
            <h1 className="font-display font-bold text-display-md sm:text-display-lg mt-3 mb-4">
              Church Blog
            </h1>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredPosts.map((post) => (
              <div
                key={post.id}
                className="bg-card border border-border rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col justify-between"
              >
