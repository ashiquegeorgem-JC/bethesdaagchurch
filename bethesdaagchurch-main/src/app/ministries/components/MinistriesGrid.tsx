...
const ministries = [
{
  ...
  imgAlt: 'Children laughing together in bright colorful classroom setting with natural light, joyful expressions',
  color: 'bg-amber-50'
},
{
  name: 'Youth Ministry',
  ...
  imgAlt: 'Energetic group of teenagers in worship with hands raised, bright stage lighting, authentic expressions',
  color: 'bg-green-50'
},
{
  ...
  imgAlt: 'Multigenerational family seated together in church pew, warm natural light, genuine smiles',
  color: 'bg-amber-50'
},
{
  ...
  imgAlt: 'Group of women in prayer circle with bowed heads and joined hands, warm indoor natural light',
  color: 'bg-rose-50'
},
{
  name: 'Men\'s Ministry',
  ...
  imgAlt: 'Group of men in prayer together in church setting, heads bowed, hands joined in circle',
  color: 'bg-blue-50'
},
{
  ...
  imgAlt: 'Hands raised in prayer in dimly lit sanctuary with atmospheric warm amber light from above',
  color: 'bg-purple-50'
},
{
  ...
  imgAlt: 'Church volunteers distributing food and supplies to community members in outdoor setting, bright daylight',
  color: 'bg-amber-50'
},
{
  name: 'Missions',
  ...
  imgAlt: 'Mission team gathered for prayer before departure, hands joined in circle in outdoor setting, sunrise light',
  color: 'bg-green-50'
}];
...
export default function MinistriesGrid() {
  ...
  return (
    <section ref={sectionRef} className="py-20 bg-church-ivory relative overflow-hidden" aria-labelledby="ministries-grid-heading">
      <div className="absolute inset-0 wave-texture opacity-30 pointer-events-none" />
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-14 animate-on-scroll">
          <span className="text-xs font-semibold tracking-widest uppercase text-church-bronze mb-3 block">Eight Ministries</span>
          <div className="section-divider-gold w-16 mx-auto mb-4" />
          <h2 id="ministries-grid-heading" className="font-display text-4xl sm:text-5xl font-bold text-church-green">
        ...
        <div className="space-y-8">
          ...
          <div
            ...
            style={{ transitionDelay: `${i * 60}ms` }}>
              ...
              <div className={`grid grid-cols-1 lg:grid-cols-5 ${i % 2 !== 0 ? 'lg:grid-flow-dense' : ''}`}>
                {/* Image */}
                <div className={`lg:col-span-2 relative aspect-video lg:aspect-auto overflow-hidden ${i % 2 !== 0 ? 'lg:col-start-4' : ''}`}>
                  <AppImage
                  src={ministry?.img}
                  alt={ministry?.imgAlt}
                  fill
                ...
                {/* Content */}
                <div className={`lg:col-span-3 p-7 sm:p-10 flex flex-col justify-center ${i % 2 !== 0 ? 'lg:col-start-1 lg:row-start-1' : ''}`}>
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <span className="text-church-gold text-xs font-semibold uppercase tracking-widest">{ministry?.tagline}</span>
                  </div>
                  <h3 className="font-display text-2xl sm:text-3xl font-bold text-church-green mb-3">{ministry?.name}</h3>
                  <p className="text-church-bronze text-sm leading-relaxed mb-6">{ministry?.desc}</p>
